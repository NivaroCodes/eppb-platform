...
import { FileText, Clock, Layers, GitBranch, ArrowRight } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-8 space-y-12">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <MetaCard icon={Layers} label="Шагов" value={String(form.schema.steps.length)} />
                <MetaCard icon={GitBranch} label="Интеграций" value={String(form.schema.config?.integrationRequired?.length || 0)} />
                  ...
                  {form.schema.steps.map((step, idx) => (
                    <div key={step.id} className="flex gap-6 group">
                      <div className="flex flex-col items-center">
                        ...
                        {idx < form.schema.steps.length - 1 && (
...
function MetaCard({ icon: Icon, label, value, isMono }: { icon: any; label: string; value: string; isMono?: boolean }) {
  return (
